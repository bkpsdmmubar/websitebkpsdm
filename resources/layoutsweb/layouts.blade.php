...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="shortcut icon" href="{{ asset('assets/icons/lg-munabarat.ico') }}">
        ...
        <link href="{{ asset('assets/css/magnific.css') }}" rel="stylesheet">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="d-flex mb-3">
                    ...
                    <img src="{{ asset('assets/icons/ig.jpg') }}" height="30" width="30" class="me-4" alt="">
                    </a>
                    <a href="" target="_blank" class="text-decoration-none text-dark">
                    ...
                    <a href="" target="_blank" class="text-decoration-none text-dark">
                    <img src="{{ asset('assets/icons/tw.jpg') }}" height="30" width="30" class="me-4" alt="">
                    </a>
                    <a href="" target="_blank" class="text-decoration-none text-dark">
                    <img src="{{ asset('assets/icons/youtube.png') }}" height="30" width="30" class="me-4" alt="">
                    </a>
                </div>
                </div>
                ...
                <h5 class="fw-bold mb-3">Kontak Kami</h5>
                    <ul class="nav flex-colomn">
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">bkd.munabarat@gmail.com</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">www.bkpp.munabarat.go.id</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">0821-XXX-XXX</a></li>
                    </ul>
                </div>
                ...
                <div class="col-12 col-md-3 mb-3">
                <h5 class="fw-bold mb-3">Kontak Kami</h5>
                <p> Jl. Kompleks Perkantoran Bumi Praja Laworo <br>
                    Desa Lombu Jaya - Kec. Sawerigadi <br>
