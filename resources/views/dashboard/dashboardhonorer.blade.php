@extends('layouts.presensihonorer.presensi')
@section('content')

<div class="section" id="user-section">
    <div id="user-detail">
        <div class="avatar">
            @if (!@empty(Auth::guard('honorer')->user()->image))
            @php
                $path = Storage::url('uploads/honorer/'.Auth::guard('honorer')->user()->image);
            @endphp
        ...
        <div id="user-info">
            <h3 id="user-name">{{ Auth::guard('honorer')->user()->nama }}</h3>
            @foreach ($leaderboard as $d)
                <small class="badge bg-danger">{{ $d->jabatan }}</small>
            @endforeach
        </div>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-body text-center">
            <div class="list-menu">
                ...
                <div class="item-menu text-center">
                    <div class="menu-icon">
                        <a href="{{ asset('/proseslogouthonorer')}}" class="orange" style="font-size: 40px;">
...
<div class="section mt-2" id="presence-section">
                    ...
                    <div class="card-body">
                        <div class="presencecontent">
                            <div class="iconpresence">
                                @if ($presensihonorerhariini != null)
                                @php
                                    $path = Storage::url('uploads/absensi/'.$presensihonorerhariini->foto_in);
                                @endphp
                            ...
                            <div class="presencedetail">
                                ...
                                <span>{{ $presensihonorerhariini != null ? $presensihonorerhariini->jam_in : 'Belum Absen'  }}</span>
            ...
            <div class="col-6">
                <div class="card gradasired">
                    <div class="card-body">
                        <div class="presencecontent">
                            <div class="iconpresence">
                                @if ($presensihonorerhariini != null  && $presensihonorerhariini->jam_out != null)
                                @php
                                    $path = Storage::url('uploads/absensi/'.$presensihonorerhariini->foto_out);
                                @endphp
                                <img src="{{ url($path)}}" alt="" class="imaged w48">
                                @else
                                    <ion-icon name="camera"></ion-icon>
                            ...
                            <div class="presencedetail">
                                ...
                                <span>{{ $presensihonorerhariini != null && $presensihonorerhariini->jam_out != null ? $presensihonorerhariini->jam_out : 'Belum Absen'  }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="rekappresensihonorer">
                ...
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-heigh: 0.8rem">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="badge bg-danger">{{ $rekappresensihonorer->jmlhadir}}</span>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-heigh: 0.8rem">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="badge bg-danger">{{ $rekappresensihonorer->jmlizin}}</span>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-heigh: 0.8rem">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="badge bg-danger">{{ $rekappresensihonorer->jmlsakit}}</span>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-heigh: 0.8rem">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="badge bg-danger">{{ $rekappresensihonorer->jmlcuti}}</span>
                            </div>
                        </div>
    ...
    <div class="rekappresensihonorer mt-2">
        {{-- <div id="chartdiv"></div> --}}
        <div class="row">
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-heigh: 0.8rem">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="badge bg-danger">{{ $rekappresensihonorer->jmltugasluar}}</span>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-heigh: 0.8rem">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="badge bg-danger">{{ $rekappresensihonorer->jmlalpa}}</span>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-heigh: 0.8rem">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="badge bg-danger">{{ $rekappresensihonorer->jmltepat}}</span>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-heigh: 0.8rem">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="badge bg-danger">{{ $rekappresensihonorer->jmltelat}}</span>
                            </div>
                        </div>
        ...
        <div class="tab-content mt-2" style="margin-bottom:100px;">
            <div class="tab-pane fade show active" id="home" role="tabpanel">
                ...
                <ul class="listview image-listview">
                    @foreach ($historihonorerbulanini as $d)
                    @php
                    ...
                    <li>
                        <div class="item">
                            ...
                            <div class="in">
                                ...
                                <span class="badge badge-danger">{{ $presensihonorerhariini != null && $d->jam_out != null ? $d->jam_out
                                : 'Belum Absen'}} </span>
                            </div>
                        </div>
                    </li>
