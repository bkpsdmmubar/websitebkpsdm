    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="kode_jabatan" name="kode_jabatan" readonly value="{{ $jabatan->kode_jabatan }}" class="form-control" placeholder="NIK (Nomor Induk Karyawan)">
            </div>
            ...
            <div class="input-icon mb-3">
                ...
                <input type="text" id="eselon" name="eselon" value="{{ $jabatan->eselon }}" class="form-control" placeholder="Eselon">
            </div>
            ...
            <div class="input-icon mb-3">
                ...
                <input type="text" id="jenis" name="jenis" value="{{ $jabatan->jenis }}" class="form-control" placeholder="Jenis Jabatan">
            </div>
