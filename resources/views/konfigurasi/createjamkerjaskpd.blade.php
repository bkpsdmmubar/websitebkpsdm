...
<div class="page-body">
    <div class="container-xl">
        <form action="/konfigurasi/jamkerjaskpd/store" method="POST">
            @csrf
        <div class="row">
            <div class="col-12">
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <select name="kode_skpd" id="kode_skpd" class="form-select" required>
                                <option value="">Pilih SKPD</option>
                                @foreach ($skpd as $d)
                                <option value="{{ $d->kode_skpd }}">{{ $d->nama_skpd }}</option>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <select name="kode_unitkerja" id="kode_unitkerja" class="form-select" required>
                                <option value="">Pilih Unit Kerja</option>
                                @foreach ($unitkerja as $e)
                                <option value="{{ $e->kode_unitkerja }}">{{ $e->nama_unitkerja }}</option>
