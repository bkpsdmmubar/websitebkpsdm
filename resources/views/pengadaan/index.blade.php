                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="eselon" name="eselon" value="" class="form-control" placeholder="Eselon">
                            </div>
                            ...
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="jenis" name="jenis" value="" class="form-control" placeholder="Jenis Jabatan">
                            </div>
