<form action="/gaji/{{ $gaji->id }}/update"  method="POST" id="frmGaji">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="golongan" name="golongan" value="golongan" class="form-control" placeholder="Golongan">
            </div>
            ...
            <div class="input-icon mb-3">
                ...
                <input type="text" id="masa_kerja" name="masa_kerja" value="masa_kerja" class="form-control" placeholder="Masa Kerja">
            </div>
            ...
            <div class="input-icon mb-3">
                ...
                <input type="text"  id="gaji_pokok" name="gaji_pokok" value="gaji_pokok" class="form-control" placeholder="Gaji Pokok">
            </div>
