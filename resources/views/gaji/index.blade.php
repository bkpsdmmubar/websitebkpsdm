                    ...
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="form-group">
                                                <input type="text" name="golongan" class="form-control" placeholder="Cari Tabel Gaji" value="{{ Request('golongan')}}">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                        ...
                        <div class="row  mt-3">
                            <div class="col-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $d->golongan}}</td>
                                            <td>{{ $d->masa_kerja}}</td>
                                            <td>@currency($d->gaji_pokok)</td>
                                            <td>
                                                <div class="btn-group">

                                                    <div class="col-3 col-sm col-md-2 col-xl-auto py-3" >
                                                        <a href="#" id="{{ $d->id }}" class="edit btn btn-tabler w-100 btn-icon" aria-label="Tabler">
                                ...
                                {{ $gaji->links('vendor.pagination.bootstrap-5')}}
                            </div>
                            </div>
                        </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="golongan" name="golongan" value="" class="form-control" placeholder="Golongan">
                            </div>
                            ...
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" id="masa_kerja" name="masa_kerja" value="" class="form-control" placeholder="Masa Kerja">
                            </div>
                            ...
                            <div class="input-icon mb-3">
                                ...
                                <input type="text"  id="gaji_pokok" name="gaji_pokok" value="" class="form-control" placeholder="Gaji Pokok">
                            </div>
...
<div class="modal modal-blur fade" id="modal-editgaji" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Edit Tabel Gaji</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
