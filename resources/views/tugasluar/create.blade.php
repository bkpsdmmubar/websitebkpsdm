...
<div class="appHeader bg-primary text-light">
    ...
    <div class="pageTitle">Buat Tugas Luar</div>
    <div class="right"></div>
</div>
...
<form action="/tugasluar/store" method="POST" id="frmtugasluar" autocomplete="off" enctype="multipart/form-data">
    @csrf
    <div class="col">
        <div class="form-group boxed">
            <select name="kode_tugasluar" id="kode_tugasluar" class="form-control">
                <option value="">Pilih Tugas Luar</option>
                @foreach ($mastertugasluar as $c)
                <option value="{{ $c->kode_tugasluar }}">{{ $c->nama_tugasluar }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group boxed">
        ...
        <div class="custom-file-upload" id="fileUpload1" style="height: 100px !important">
            ...
            aria-label="cloud upload outline"></ion-icon>
                        <i>Tap to Upload Surat Tugas Luar</i>
                    </strong>
                </span>
            </label>
        </div>
...
<script>
    ...
    $("#frmtugasluar").submit(function() {
        ...
        if (kode_tugasluar == "") {
            Swal.fire({
                title: 'Oops !',
                text: 'Jenis tugasluar Harus Di Isi',
                icon: 'Warning',
            });
            return false;
            ...
            Swal.fire({
                title: 'Oops !',
                text: 'File Surat tugasluar Harus Di Isi',
                icon: 'Warning',
            });
            return false;
        } else if (keterangan == "") {
