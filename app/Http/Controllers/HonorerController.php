...
//         $query = Honorer::query();
//         $query->select('honorer.*','nama_skpd');
//         $query->join('skpd','honorer.kode_skpd','=','skpd.kode_skpd');
//         $query->join('unitkerja','honorer.kode_unitkerja','=','unitkerja.kode_unitkerja');
//         $query->join('jabatan','honorer.kode_jabatan','=','jabatan.kode_jabatan');
//         $query->orderBy('nama_lengkap');
//         if (!empty($request->nama_honorer)) {
//             $query->where('nama_lengkap','like','%'.$request->nama_honorer.'%');
//         }

//         if (!empty($request->kode_skpd)) {
//             $query->where('honorer.kode_skpd', $request->kode_skpd);
//         }

//         if (!empty($request->kode_unitkerja)) {
//             $query->where('honorer.kode_skpd', $request->kode_unitkerja);
//         }

//         if (!empty($request->kode_jabatan)) {
//             $query->where('honorer.kode_jabatan', $request->kode_jabatan);
//         }

//         $honorer = $query->paginate(5);

//         $honorer = DB::table('honorer')->orderBy('nik')
//         ->join('skpd','honorer.kode_skpd','=','skpd.kode_skpd')
//         ->join('unitkerja','honorer.kode_unitkerja','=','unitkerja.kode_unitkerja')
//         ->join('jabatan','honorer.kode_jabatan','=','jabatan.kode_jabatan')
//         ->join('agama','honorer.kode_agama','=','agama.kode_agama')
//         ->paginate(10);
...
//         return view('honorer.index', compact('honorer','skpd','unitkerja','agama','jabatan'));
//     }

//     public function viewhonorer($nik, Request $request)
//     {
...
//         $query->join('unitkerja','honorer.kode_unitkerja','=','unitkerja.kode_unitkerja');
//         $query->join('jabatan','honorer.kode_jabatan','=','jabatan.kode_jabatan');
//         $query->join('riwayat_golongan','honorer.kode_riwayat_golongan','=','riwayat_golongan.kode_riwayat_golongan');
//         $query->orderBy('nama_lengkap');
//         if (!empty($request->nama_honorer)) {
//             $query->where('nama_lengkap','like','%'.$request->nama_honorer.'%');
//         }
...
//         // $riwayatgolongan = honorer::findOrFail($nip);
...
//         return view('honorer.viewhonorer', compact('honorer','skpd','unitkerja','agama','kawin','jenisjabatan'));
//     }
