...
class JabatanController extends Controller
{
    public function index(Request $request){
        ...
        $query->join('jenis_jabatan','jabatan.kode_jenis_jabatan','=','jenis_jabatan.kode_jenis_jabatan');
        $query->select('*');
        ...
        $jenis_jabatan = DB::table('jenis_jabatan')->get();

        return view('jabatan.index', compact('jabatan', 'skpd','unitkerja','jenis_jabatan'));
    ...
    public function edit(Request $request){
        ...
        return view('jabatan.edit', compact('jabatan', 'skpd','unitkerja','jenis_jabatan'));
    }
