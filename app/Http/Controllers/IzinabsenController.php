...
class IzinabsenController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($cekpresensi->count() > 0) {
            ...
            return redirect('presensi/izin')->with(['error'=>'Tidak Dapat Melakukan Pengajuan Izin Pada Tanggal ' . $blacklistdate .' ,Karena Sudah Digunakan/Sudah Melakukan Presensi! Silahkan Cek Tanggal Pengajuan Izin.']);
        
        } else if ($cekpengajuan->count() > 0) {
            return redirect('presensi/izin')->with(['error'=>'Tidak Dapat Melakukan Pengajuan Izin Pada Tanggal Tersebut ,Karena Sudah Digunakan/Sudah Melakukan Presensi! Silahkan Cek Tanggal Pengajuan Izin.']);
        } else {
